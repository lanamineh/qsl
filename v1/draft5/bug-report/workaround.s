...
.Lfunc_end3:
	...
	.cfi_endproc
                                        # -- End function
	.section	.text.startup,"ax",@progbits
	.p2align	4, 0x90         # -- Begin function _GLOBAL__sub_I_workaround.cpp
	.type	_GLOBAL__sub_I_workaround.cpp,@function
_GLOBAL__sub_I_workaround.cpp:          # @_GLOBAL__sub_I_workaround.cpp
	.cfi_startproc
# %bb.0:
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	retq
.Lfunc_end4:
	.size	_GLOBAL__sub_I_workaround.cpp, .Lfunc_end4-_GLOBAL__sub_I_workaround.cpp
	.cfi_endproc
                                        # -- End function
...
.L.str.1:
	...
	.p2align	3
	.quad	_GLOBAL__sub_I_workaround.cpp
	...
	.addrsig_sym _GLOBAL__sub_I_workaround.cpp
