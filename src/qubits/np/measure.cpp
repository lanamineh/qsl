...
void qsl::Qubits<qsl::Type::NP, Fp>::collapse(unsigned targ, unsigned outcome,
					      Fp factor)
{
...
template<std::floating_point Fp>
std::vector<typename qsl::Qubits<qsl::Type::NP, Fp>::Dist> qsl::Qubits<qsl::Type::NP, Fp>::generateDist()
{
...
template<std::floating_point Fp>
int qsl::Qubits<qsl::Type::NP, Fp>::measure(unsigned targ)
{
...
template<std::floating_point Fp>
std::size_t qsl::Qubits<qsl::Type::NP, Fp>::measureAll()
{
    // Construct cumulative probability vector
...
template<std::floating_point Fp>
Fp qsl::Qubits<qsl::Type::NP, Fp>::prob(unsigned targ, unsigned outcome) const
{
    Fp probability = 0;
...
template<std::floating_point Fp>
Fp qsl::Qubits<qsl::Type::NP, Fp>::postselect(unsigned targ,
						  unsigned outcome)
{
...
template<std::floating_point Fp>
std::size_t qsl::Qubits<qsl::Type::NP, Fp>::drawSample(const std::vector<Dist> & dist)
{
...
template<std::floating_point Fp>
std::vector<std::size_t> qsl::Qubits<qsl::Type::NP, Fp>::sample(unsigned targ,
								std::size_t nsamples)
{
...
template<std::floating_point Fp>
std::map<std::size_t, std::size_t> qsl::Qubits<qsl::Type::NP, Fp>::sampleAll(std::size_t nsamples)
{    
    // Construct cumulative probability vector
    std::vector<Dist> dist = generateDist();
...
template<std::floating_point Fp>
std::map<std::size_t, std::size_t> qsl::Qubits<qsl::Type::NP, Fp>::sampleAll2(std::size_t nsamples)
{        
