...
template<std::floating_point Fp>
void qsl::Qubits<qsl::Type::Resize, Fp>::npRotateX(unsigned q1,
						   unsigned q2,
						   Fp angle)
{
    // Store variables
...
template<std::floating_point Fp>
void qsl::Qubits<qsl::Type::Resize, Fp>::npRotateY(unsigned q1,
						   unsigned q2,
						   Fp angle)
{
    // Store variables
...
template<std::floating_point Fp>
void qsl::Qubits<qsl::Type::Resize, Fp>::npHadamard(unsigned q1,
						    unsigned q2)
{
    std::size_t small_bit = 1 << std::min(q1, q2);
    std::size_t large_bit = 1 << std::max(q1, q2);
