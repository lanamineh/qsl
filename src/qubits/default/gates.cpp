...
template<std::floating_point Fp>
void qsl::Qubits<qsl::Type::Default, Fp>::pauliY(unsigned targ)
{
    std::size_t k = 1 << targ;
    for (std::size_t s = 0; s < dim; s += 2*k) { 
	for (std::size_t r = 0; r < k; r++) {
...
template<std::floating_point Fp>
void qsl::Qubits<qsl::Type::Default, Fp>::rotateY(unsigned targ, Fp angle)
{
    // Store variables
    Fp cos = std::cos(angle/2);
    Fp sin = std::sin(angle/2);
...
template<std::floating_point Fp>
void qsl::Qubits<qsl::Type::Default, Fp>::rotateZ(unsigned targ, Fp angle)
{
    // Store variables
    Fp cos = std::cos(angle/2);
    Fp sin = std::sin(angle/2);
...
template<std::floating_point Fp>
void qsl::Qubits<qsl::Type::Default, Fp>::controlY(unsigned ctrl,
						   unsigned targ)
{
    std::size_t small_bit = 1 << std::min(ctrl, targ);
    std::size_t large_bit = 1 << std::max(ctrl, targ);
...
template<std::floating_point Fp>
void qsl::Qubits<qsl::Type::Default, Fp>::controlRotateX(unsigned ctrl,
							 unsigned targ,
							 Fp angle)
{
    // Store variables
...
template<std::floating_point Fp>
void qsl::Qubits<qsl::Type::Default, Fp>::controlRotateY(unsigned ctrl,
							 unsigned targ,
							 Fp angle)
{
    // Store variables
...
template<std::floating_point Fp>
void qsl::Qubits<qsl::Type::Default, Fp>::controlRotateZ(unsigned ctrl,
							 unsigned targ,
							 Fp angle)
{
    // Store variables
...
template<std::floating_point Fp>
void qsl::Qubits<qsl::Type::Default, Fp>::controlHadamard(unsigned ctrl,
							  unsigned targ)
{
    std::size_t small_bit = 1 << std::min(ctrl, targ);
    std::size_t large_bit = 1 << std::max(ctrl, targ);
...
template<std::floating_point Fp>
void qsl::Qubits<qsl::Type::Default, Fp>::fswap(unsigned q1, unsigned q2)
{
    std::size_t small_bit = 1 << std::min(q1, q2);
    std::size_t large_bit = 1 << std::max(q1, q2);
