 ...
 *        set/get methods of the Experimental qubits class.
 */
...
template<>
const std::string qsl::Qubits<qsl::Type::Experimental, double>::name =
    std::string("Qub<exp,double>");

template<>
const std::string qsl::Qubits<qsl::Type::Experimental, float>::name =
    std::string("Qub<exp,float>");

template<std::floating_point Fp>
qsl::Qubits<qsl::Type::Experimental, Fp>::Qubits(unsigned nqubits_in) 
...
template<std::floating_point Fp>
qsl::Qubits<qsl::Type::Experimental, Fp>::Qubits(const std::vector<qsl::complex<Fp>> & state)
...
template<std::floating_point Fp>
void qsl::Qubits<qsl::Type::Experimental, Fp>::reset()
{
...
template<std::floating_point Fp>
void qsl::Qubits<qsl::Type::Experimental, Fp>::setState(const std::vector<qsl::complex<Fp>> & state_in)
{
...
template<std::floating_point Fp>
void qsl::Qubits<qsl::Type::Experimental, Fp>::setBasisState(std::size_t index)
{
...
template<std::floating_point Fp>
void qsl::Qubits<qsl::Type::Experimental, Fp>::operator = (const Qubits & old)
{
...
template<std::floating_point Fp>
std::vector<qsl::complex<Fp>> qsl::Qubits<qsl::Type::Experimental, Fp>::getState() const
{
    return state;
}

template<std::floating_point Fp>
unsigned qsl::Qubits<qsl::Type::Experimental, Fp>::getNumQubits() const
{
    return nqubits;
}
...
template<std::floating_point Fp>
void qsl::Qubits<qsl::Type::Experimental, Fp>::print(std::ostream & os) const
{
