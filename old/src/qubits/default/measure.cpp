...
void qsl::Qubits<qsl::Type::Default, Fp>::collapse(unsigned targ,
						   unsigned outcome,
						   Fp factor)
{
...
template<std::floating_point Fp>
std::vector<typename qsl::Qubits<qsl::Type::Default, Fp>::Dist> qsl::Qubits<qsl::Type::Default, Fp>::generateDist()
{
...
template<std::floating_point Fp>
int qsl::Qubits<qsl::Type::Default, Fp>::measure(unsigned targ)
{
...
template<std::floating_point Fp>
std::size_t qsl::Qubits<qsl::Type::Default, Fp>::measureAll()
{
    // Construct cumulative probability vector
...
template<std::floating_point Fp>
Fp qsl::Qubits<qsl::Type::Default, Fp>::prob(unsigned targ, unsigned outcome)
    const
{
    Fp probability = 0;
...
template<std::floating_point Fp>
Fp qsl::Qubits<qsl::Type::Default, Fp>::postselect(unsigned targ,
						   unsigned outcome)
{
...
template<std::floating_point Fp>
std::size_t qsl::Qubits<qsl::Type::Default, Fp>::drawSample(const std::vector<Dist> & dist)
{
...
template<std::floating_point Fp>
std::vector<std::size_t> qsl::Qubits<qsl::Type::Default, Fp>::sample(unsigned targ,
								     std::size_t nsamples)
{
...
template<std::floating_point Fp>
std::map<std::size_t, std::size_t> qsl::Qubits<qsl::Type::Default, Fp>::sampleAll(std::size_t nsamples)
{    
    // Construct cumulative probability vector
    std::vector<Dist> dist = generateDist();
...
template<std::floating_point Fp>
std::map<std::size_t, std::size_t> qsl::Qubits<qsl::Type::Default, Fp>::sampleAll2(std::size_t nsamples)
{        
